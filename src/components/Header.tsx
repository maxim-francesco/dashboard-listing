    ...
    <header className="h-16 bg-card text-foreground border-b border-border flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link
          ...
          aria-label="Firma"
          className={cn(
            "lg:hidden w-9 h-9 min-h-[44px] min-w-[44px] rounded-lg flex items-center justify-center transition-colors shrink-0",
            isFirmaActive
              ? "bg-primary text-primary-foreground"
        ...
        <Link
          to="/firma"
          className={cn(
            "hidden lg:flex px-4 py-2 text-sm font-medium rounded-md transition-colors items-center gap-2 cursor-pointer min-h-[44px]",
            isFirmaActive
              ? "bg-primary text-primary-foreground"
